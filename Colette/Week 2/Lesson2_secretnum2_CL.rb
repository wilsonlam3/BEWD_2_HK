...
def chance_left(count)
	if count == 3
		"Game over. The secret number is #{Secret_number}."
	else
...
until count > 3
	...
	if Secret_number == guess
		...
		result = "#{process_guess(guess)} #{chance_left(count)}"
		puts result
	end
	count +=1
end	