...
def create_apartment
  ...
  puts "How many square feet is apartment #{apt_name}?"
  apt_sqft = gets.to_i

  puts "How many bedrooms does apartment #{apt_name} have?"
  apt_bedrooms = gets.to_i

  puts "How many bathrooms does apartment #{apt_name} have?"
  apt_bathrooms = gets.to_i

  Apartment.new(apt_name, apt_sqft, apt_bedrooms, apt_bathrooms)
end
...
0.upto(apt_count - 1) do |unit|
  ...
  puts "Is unit #{apartment.apt_name} rented? (y)es (n)o"
